...
class AprovadoSolicitacao extends StatefulWidget {
  const AprovadoSolicitacao({Key? key}) : super(key: key);

  @override
  State<AprovadoSolicitacao> createState() => _AprovadoSolicitacaoState();
}

class _AprovadoSolicitacaoState extends State<AprovadoSolicitacao> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Solicitações Aprovadas',
            style: TextStyle(color: Color.fromRGBO(113, 0, 150, 0.8))),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('parceria')
            .where('statusParceria', isEqualTo: "Aprovado")
            .snapshots(),
